...
import utils.dependency.footnotes.internal.FootnoteBlockParser;
import utils.dependency.footnotes.internal.FootnoteLinkRefProcessor;
import utils.dependency.footnotes.internal.FootnoteNodeFormatter;
import utils.dependency.footnotes.internal.FootnoteRepository;
...
public class FootnoteExtension
    ...
    @Override
    public void extend( HtmlRenderer.Builder htmlRendererBuilder,
         String rendererType) {
